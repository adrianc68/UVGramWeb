...
public interface IAccountService
{
  ...
  Task<object> UpdatePersonalAccountData(PersonalUserData model);
  Task<MessageType> ChangePassword(ChangeActualPassword model);
  Task<MessageType> ChangePrivacy(ChangePrivacy model);
  ...
  Task<String> UpdateProfileImage(Stream fileStream, string fileName, string contentType);
